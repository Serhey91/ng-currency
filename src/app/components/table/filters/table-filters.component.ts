import { Component, ElementRef, ViewChild, OnInit, AfterContentChecked, OnDestroy } from '@angular/core';
...
export class TableFiltersComponent implements OnInit, AfterContentChecked, OnDestroy {
